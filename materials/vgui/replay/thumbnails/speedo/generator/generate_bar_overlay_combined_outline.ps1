...
# Generate image
magick.exe -size $VTFSize xc:$backgroundColor +antialias -fill white -draw $SHAPE_h_sideLine -draw $SHAPE_h_sideLineL -draw $SHAPE_h_topLINE -draw $SHAPE_h_botLINE -draw $SHAPE_v_sideLineL -draw $SHAPE_v_sideLine -draw $SHAPE_v_topLine -draw $SHAPE_v_botLINE "$name.png"
