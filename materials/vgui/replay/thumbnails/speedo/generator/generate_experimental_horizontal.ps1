...
$folder = "numbers_experimental_horizontal"
...
for ($num = 0; $num -le $maxNumber; $num++) {
    ...
    $line = "rectangle $linePosition,0 $numbig,$end"
    magick.exe -size $VTFSize xc:$backgroundColor -fill white -draw $line "$imagesFolder\$num.png"
    # Update progress bar
