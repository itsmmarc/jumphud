	...
	"MainMenuOverride"
	{
		...
		"SafeMode"
		{
			"Customizations_Panel"
			{
                ...
                "HUD_Speedos_Confirm_Dialog"        {Visible 0 ConfirmButton_Soldier_Preset_JH {Visible 0 Font HudFontSmall} ConfirmButton_Demo_Preset_JH {Visible 0 Font HudFontSmall} ConfirmButton_Bars_Preset_JH {Visible 0 Font HudFontSmall} ConfirmButton_Graphs_Preset_JH {Visible 0 Font HudFontSmall} ConfirmButton_Reset_HUD {Visible 0 Font HudFontSmall} ConfirmButton_Restart_Game {Visible 0 Font HudFontSmall}}
